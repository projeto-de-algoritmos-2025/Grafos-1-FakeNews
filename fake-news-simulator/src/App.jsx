...
function App() {
  ...
  const spreadFakeNews = (startNodeId) => {
    ...
    while (queue.length > 0) {
      ...
      const outgoingLinks = myGraphData.links.filter(
      ...
      for(const link of outgoingLinks){
        ...
        if(!visited.has(neighbourId) && Math.random() < probability) {
          visited.add(neighbourId);
          newInfectedNodes[neighbourId] = step + 1;
          queue.push({id: neighbourId, step: step + 1});
        }
      }
    }
